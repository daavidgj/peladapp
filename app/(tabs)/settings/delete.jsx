        ...
        <View style={{ flex: 1 }} className="px-10 py-12 gap-5 bg-white">
            ...
            <View >
                ...
                <View className="gap-5 py-10">
                    ...
                    <MyInput placeholder="Digite sua senha" secureTextEntry value={novaSenha} onChangeText={setNovaSenha} icon="lock" />

                    <View className="w-full items-center py-5 ">
                        <Botao1 onpressProp={deletarConta} cta="Deletar Conta"></Botao1>
                    </View>
                </View>
            </View>
